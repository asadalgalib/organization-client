    ...
    return (
        <div className='bg-accent py-20 px-4 min-h-[calc(100vh-50px)] lg:min-h-[calc(100vh-71.55px)] flex items-center justify-center'>
            <div className=' bg-white py-10 px-5 rounded dark:bg-[#0a0e15] max-w-4xl mx-auto flex flex-col items-center justify-center'>
                <div className='mb-2'>
                    <h1 className='lg:text-3xl text-2xl text-black dark:text-white font-semibold text-center'>Login Your Account</h1>
                ...
                <div className="w-full max-w-md">
                    <form onSubmit={handleSubmit(onSubmit)} className="mt-5">
                        ...
                        <div className="form-control mt-5">
                            <button className="bg-primary font-semibold w-full py-3 text-white text-lg rounded-md">Login</button>
                        </div>
                        <div className='my-1'>
                    ...
                    <div>
                        ...
                        <div className='mt-4'>
                            <p className='text-black dark:text-white text-center'>
                                ...
                                <Link to={'/signup'}><span className='text-black dark:text-white p-1 underline font-semibold'>Signup here</span></Link>
                            </p>
                        </div>
                    </div>
                </div>
